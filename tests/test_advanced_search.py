...
class Tests(unittest.TestCase):
    ...
    def test_page_loads(self):
        driver = b_webdriver_functions.getSearchByName()
    ...
    def test_reg_no_shows_Ishan(self):
        driver = b_webdriver_functions.getSearchByRegNo()
    ...
    def test_curr_aff_shows_results(self):
        driver = b_webdriver_functions.getSearchByCurrAff()
    ...
    def test_by_location(self):
        driver = b_webdriver_functions.getSearchByLocation()

...
class f {
  ...
  i(t, i, s, h, e, n) {
    if (!t) return;
    const o = (e ? "remove" : "add") + "EventListener";
    (i = i.split(" ")).forEach((i) => {
      if (i) {
        n ||
          (e
...
function g(t, i, s) {
  let h;
  if (i.paddingFn) h = i.paddingFn(s)[t];
...
class x {
  constructor(t, i, s) {
    ((this.data = t),
      ...
      (this.zoomLevels = new v(s.options, t, i, s)),
  ...
  load() {
    if (this.usePlaceholder() && !this.placeholder) {
      const t = this.pswp.applyFilters(
        "placeholderSrc",
        !(!this.data.msrc || !this.isFirstSlide) && this.data.msrc,
        this
      );
      this.placeholder = new b(t, this.container);
    }
  ...
  appendHeavy() {
    ...
    !this.heavyAppended &&
      ...
      (this.pswp.dispatch("appendHeavy", { slide: this }).defaultPrevented ||
        ...
        this.content.state === d
          ? this.displayError()
          : (this.content.appendTo(this.container),
            this.placeholder && this.content.state === p && this.removePlaceholder()),
  ...
  displayError() {
    const t = this.content.getErrorElement();
    ((t.style.position = "absolute"),
      (t.style.left = 0),
      (t.style.top = 0),
      (this.activeErrorElement = t),
      this.setSlideHTML(t),
      this.updateContentSize(!0));
  }
  activate() {
    ((this.isActive = !0),
      this.appendHeavy(),
  ...
  destroy() {
    (this.content.remove(), this.pswp.dispatch("slideDestroy", { slide: this }));
  }
  resize() {
  ...
  updateContentSize(t) {
    ...
    (this.sizeChanged(s, h) || t) &&
      (this.placeholder && this.placeholder.setDisplayedSize(s, h),
      this.activeErrorElement && c(this.activeErrorElement, s, h),
      this.content.setDisplayedSize(s, h));
  }
  sizeChanged(t, i) {
    return (
  ...
  calculateSize() {
    const { pswp: t } = this;
    (i(this.panAreaSize, _(t.options, t.viewportSize)),
  ...
  change() {
    ...
    if (
      ...
      if (!e.dispatch("verticalDrag", { panY: s }).defaultPrevented) {
        this.v("y", s, 0.6);
        const t = 1 - Math.abs(this.M(n.pan.y));
        (e.applyBgOpacity(t), n.applyCurrentZoomPan());
      }
    } else {
      this.S("x") || (this.S("y"), s(n.pan), n.applyCurrentZoomPan());
    }
  }
  end() {
    ...
    if ((t.animations.stopAll(), s.isShifted())) {
      ...
      ((i.x < -0.5 && e < 0) || (i.x < 0.1 && e < -0.5)
        ...
        : ((i.x > 0.5 && e > 0) || (i.x > -0.1 && e > 0.5)) && ((h = -1), (i.x = Math.max(i.x, 0))),
        s.moveIndexBy(h, !0, i.x));
    }
    (t.currSlide.currZoomLevel > t.currSlide.zoomLevels.max && this.pswp.options.limitMaxZoom) ||
    this.gestures.isMultitouch
  ...
  P(t) {
    ...
    i.animations.startSpring({
      ...
      onUpdate: (h) => {
        if (a && i.bgOpacity < 1) {
          const t = 1 - (l - h) / d;
          i.applyBgOpacity(n(p + (1 - p) * t, 0, 1));
        }
...
class z {
  ...
  start() {
    ((this.I = this.pswp.currSlide.currZoomLevel),
      i(this.T, this.pswp.currSlide.pan),
  ...
  k(t, i) {
    const s = i / this.I;
    return this.D[t] - (this.C[t] - this.T[t]) * s;
  }
  correctZoomPan(t) {
    const { pswp: s } = this,
      { currSlide: h } = s;
    ...
    let p = i({}, u);
    (t &&
      ((this.D.x = 0), (this.D.y = 0), (this.C.x = 0), (this.C.y = 0), (this.I = o), i(this.T, u)),
      a && (p = { x: this.k("x", r), y: this.k("y", r) }),
      h.setZoomLevel(r),
      (p = {
      ...
      h.setZoomLevel(o));
    let d = !0;
    if ((e(p, u) && (d = !1), !d && !a && !l)) return (h.g(r), void h.applyCurrentZoomPan());
...
class T {
  ...
  Z(t, i, s) {
    ...
    if (!h.dispatch(t + "Action", { point: i, originalEvent: s }).defaultPrevented)
...
class C {
  constructor(t) {
    ((this.pswp = t),
      ...
      (this.G = !!window.PointerEvent),
      (this.supportsTouch = this.R || (this.G && navigator.maxTouchPoints > 1)),
      this.supportsTouch || (t.options.allowPanToNext = !1),
      (this.drag = new M(this)),
      (this.zoomLevels = new z(this)),
      (this.tapHandler = new T(this)),
      t.on("bindEvents", () => {
        (t.events.add(t.scrollWrap, "click", (t) => this.N(t)),
          this.G
            ? this.U("pointer", "down", "up", "cancel")
            : this.R
              ? (this.U("touch", "start", "end", "cancel"),
                (t.scrollWrap.ontouchmove = () => {}),
                (t.scrollWrap.ontouchend = () => {}))
              : this.U("mouse", "down", "up"));
      }));
  }
  U(t, i, s, h) {
    const { pswp: e } = this,
  ...
  onPointerDown(t) {
    ...
    h.opener.isOpen
      ? h.dispatch("pointerDown", { originalEvent: t }).defaultPrevented ||
        (s && (h.mouseDetected(), this.V(t)),
        h.animations.stopAll(),
        this.q(t, "down"),
        (this.pointerDown = !0),
        1 === this.B && ((this.dragAxis = null), i(this.startP1, this.p1)),
        this.B > 1 ? (this.H(), (this.isMultitouch = !0)) : (this.isMultitouch = !1))
      : t.preventDefault();
  }
  onPointerMove(t) {
    (t.preventDefault(),
  ...
  K() {
    this.isDragging &&
      ((this.isDragging = !1), this.$ || this.tt(!0), this.drag.end(), (this.dragAxis = null));
  }
  onPointerUp(t) {
    this.B &&
      (this.q(t, "up"),
      this.pswp.dispatch("pointerUp", { originalEvent: t }).defaultPrevented ||
        ...
        this.B < 2 &&
          ...
          ((this.isZooming = !1),
          this.zoomLevels.end(),
          1 === this.B && ((this.dragAxis = null), this.j()))));
  }
  X() {
  ...
  it(t) {
    ...
    this.et
      ? (this.H(), h(this.L, this.startP1) < 25 && this.tapHandler.doubleTap(this.startP1, t))
      : (i(this.L, this.startP1),
        (this.et = setTimeout(() => {
  ...
  q(t, s) {
    if (this.G) {
      const h = this.O.findIndex((i) => i.id === t.pointerId);
      ("up" === s && h > -1
        ? this.O.splice(h, 1)
        : "down" === s && -1 === h
          ? this.O.push(this.nt(t, {}))
          : h > -1 && this.nt(t, this.O[h]),
        (this.B = this.O.length),
        this.B > 0 && i(this.p1, this.O[0]),
        this.B > 1 && i(this.p2, this.O[1]));
    } else
      ((this.B = 0),
        t.type.indexOf("touch") > -1
          ? t.touches &&
            t.touches.length > 0 &&
            (this.nt(t.touches[0], this.p1),
            this.B++,
            t.touches.length > 1 && (this.nt(t.touches[1], this.p2), this.B++))
          : (this.nt(t, this.p1), "up" === s ? (this.B = 0) : this.B++));
  }
  st() {
...
class D {
  ...
  appendHolders() {
    ...
    for (let i = 0; i < 3; i++) {
      ...
      ((s.style.display = 1 === i ? "block" : "none"), this.itemHolders.push({ el: s }));
    }
  }
  canBeSwiped() {
  ...
  moveIndexBy(t, i, s) {
    ...
    (h.options.loop
      ...
      : (e < 0 ? (e = 0) : e >= h.getNumItems() && (e = h.getNumItems() - 1),
    ...
    if (
      (i
        ? (h.animations.startSpring({
          ...
          Math.abs(h.potentialIndex - h.currIndex) > 1 && this.updateCurrItem())
  ...
  moveTo(t, i) {
    ...
    (!this.pswp.options.loop &&
      ...
      ((s < 0 && h > 0) || (s >= this.pswp.getNumItems() - 1 && h < 0)) && (t = this.x + 0.35 * h)),
      (this.x = t),
...
class I {
  constructor(t) {
    ((this.pswp = t),
      t.on("bindEvents", () => {
        (t.options.initialPointerPos || this.ct(),
          t.events.add(document, "focusin", this.lt.bind(this)),
          t.events.add(document, "keydown", this.ut.bind(this)));
      }));
    const i = document.activeElement;
    t.on("destroy", () => {
      t.options.returnFocus && i && this.dt && i.focus();
    });
  }
  ct() {
...
class A {
  constructor(t) {
    this.props = t;
    const { target: i, onComplete: s, transform: h } = t;
    let { duration: e, easing: n } = t;
    ...
    ((this.ft = i),
      ...
      (this._t = setTimeout(() => {
        (a(i, o, e, n),
          (this._t = setTimeout(() => {
            (i.addEventListener("transitionend", this.gt, !1),
              i.addEventListener("transitioncancel", this.gt, !1),
              (i.style[o] = r));
          }, 30)));
      }, 0)));
  }
  ...
  destroy() {
    (this._t && clearTimeout(this._t),
      a(this.ft),
      this.ft.removeEventListener("transitionend", this.gt, !1),
      this.ft.removeEventListener("transitioncancel", this.gt, !1),
      this.vt || this.yt());
  }
}
class E {
  constructor(t, i, s) {
    ((this.velocity = 1e3 * t),
      (this.bt = i || 0.75),
      (this.xt = s || 12),
      this.bt < 1 && (this.Mt = this.xt * Math.sqrt(1 - this.bt * this.bt)));
  }
  easeFrame(t, i) {
    let s,
      h = 0;
    i /= 1e3;
    const e = Math.E ** (-this.bt * this.xt * i);
    if (1 === this.bt)
      ...
      ((h = e * (t * n + s * o)),
        (this.velocity = h * -this.xt * this.bt + e * (-this.Mt * t * o + this.Mt * s * n)));
    }
    return h;
  }
}
    ...
    const p = () => {
      this.zt &&
        ...
        Math.abs(u) < 1 && Math.abs(c.velocity) < 50
          ...
          : ((l = Date.now()), e(u + s), (this.zt = requestAnimationFrame(p))));
    };
...
class L {
  constructor(t) {
    ((this.pswp = t), t.events.add(t.template, "wheel", this.Tt.bind(this)));
  }
  Tt(t) {
    t.preventDefault();
        ...
        if (i.isZoomable()) {
          ...
          (1 === t.deltaMode ? (s *= 0.05) : (s *= t.deltaMode ? 1 : 0.002),
            ...
            this.pswp.options.getWheelZoomFactorFn &&
              (s = this.pswp.options.getWheelZoomFactorFn(t, this.pswp)));
          const e = i.currZoomLevel * s;
          i.zoomTo(e, { x: t.clientX, y: t.clientY });
        }
      } else
        i.isPannable() &&
          (1 === t.deltaMode && ((s *= 18), (h *= 18)), i.panTo(i.pan.x - s, i.pan.y - h));
  }
}
class F {
  constructor(i, s) {
    const h = s.name || s.class;
    let e = s.html;
    ...
    let n,
      o = "pswp__";
    (s.isButton && (o += "button pswp__button--"),
      (o += s.class || s.name),
      s.isButton
        ? ((n = t(o, "button")),
          (n.type = "button"),
          (n.innerHTML = (function (t) {
            ...
            return (
              ...
              i.outlineID &&
                (s += '<use class="pswp__icn-shadow" xlink:href="#' + i.outlineID + '"/>'),
              (s += i.inner),
              (s += "</svg>"),
              s
            );
    ...
    const r = s.appendTo || "bar";
    let a;
    ("bar" === r
      ? (i.topBar || (i.topBar = t("pswp__top-bar pswp__hide-on-close", !1, i.scrollWrap)),
        (a = i.topBar))
      : (n.classList.add("pswp__hide-on-close"), (a = "wrapper" === r ? i.scrollWrap : i.template)),
      a.appendChild(n));
  }
}
function B(t, i, s) {
  (t.classList.add("pswp__button--arrow"),
    i.on("change", () => {
      i.options.loop ||
        (t.disabled = s ? !(i.currIndex < i.getNumItems() - 1) : !(i.currIndex > 0));
    }));
}
const O = {
    name: "arrowPrev",
  ...
  U = {
    ...
    onInit: (t, i) => {
      ...
      const n = () => {
        ...
        o = (i, s) => {
          t.classList[s ? "add" : "remove"]("pswp__preloader--" + i);
        },
        r = (t) => {
          s !== t &&
            ((s = t),
...
class H {
  ...
  init() {
    const { pswp: t } = this;
    ((this.isRegistered = !1),
      (this.uiElementsData = [G, O, R, N, U, V]),
  ...
  Ct() {
    ...
    const n = e < 0;
    (h === i.zoomLevels.secondary ? q(t, n) : h > i.zoomLevels.secondary ? q(t, !0) : q(t, !1),
...
class j {
  ...
  deactivate() {}
  setDisplayedSize(t, i) {
    this.element && c(this.element, t, i);
  }
  onLoaded() {
    ((this.state = p), this.slide && this.pswp.dispatch("loadComplete", { slide: this.slide }));
  }
  keepPlaceholder() {
    return this.state === u;
  }
  onError() {
    ((this.state = d),
      this.slide &&
        (this.pswp.dispatch("loadComplete", { slide: this.slide, isError: !0 }),
...
class W extends j {
  load() {
    ...
    const i = this.data.src;
    i &&
      ((this.element = t("pswp__img", "img")),
      this.data.srcset && (this.element.srcset = this.data.srcset),
      (this.element.src = i),
  ...
  setDisplayedSize(t, i) {
    ...
    s &&
      (c(s, t, "auto"),
      s.srcset &&
        (!s.dataset.largestUsedSize || t > s.dataset.largestUsedSize) &&
        ((s.sizes = t + "px"), (s.dataset.largestUsedSize = t)),
      this.slide &&
  ...
  destroy() {
    this.element &&
      ((this.element.onload = null), (this.element.onerror = null), (this.element = null));
  }
  appendTo(t) {
    ((this.isAttached = !0),
      this.slide && !this.slide.isActive && "decode" in this.element
        ? ((this.isDecoding = !0),
  ...
  getErrorElement() {
    const i = t("pswp__error-msg-container");
...
class X {
  ...
  close() {
    ...
    return (
      ...
      (this.isOpening = !1),
      (this.isClosing = !0),
      (this.At = this.pswp.options.hideAnimationDuration),
      t && t.currZoomLevel * t.width >= 4e3 && (this.At = 0),
      this.Et(),
      setTimeout(
        () => {
          this.Pt();
  ...
  It() {
    (this.pswp.off("firstZoomPan", this.It),
      this.isOpening ||
        ((this.isOpening = !0),
        (this.isClosing = !1),
        (this.At = this.pswp.options.showAnimationDuration),
        this.Et()));
  }
  Et() {
    const { pswp: t } = this,
    ...
    if (
      ("fade" === s.showHideAnimationType
        ? ((s.showHideOpacity = !0), (this.Zt = !1))
        : "none" === s.showHideAnimationType
          ? ((s.showHideOpacity = !1), (this.At = 0), (this.Zt = !1))
          : this.isOpening && t.Lt
            ? (this.Zt = t.Lt)
            : (this.Zt = this.pswp.getThumbBounds()),
      (this.Ft = i.getPlaceholderElement()),
      t.animations.stopAll(),
      (this.Bt = this.At > 50),
      (this.Ot = Boolean(this.Zt) && (!this.isClosing || !t.mainScroll.isShifted())),
      this.Ot
        ? (this.Rt = s.showHideOpacity)
        : ((this.Rt = !0), this.isOpening && (i.zoomAndPanToInitial(), i.applyCurrentZoomPan())),
      (this.Gt = !this.Rt),
      (this.Nt = this.Rt ? t.template : t.bg),
      !this.Bt)
    )
      return (
        (this.At = 0),
        ...
        (this.Gt = !1),
        (this.Rt = !0),
        void (this.isOpening && ((t.template.style.opacity = 0.003), t.applyBgOpacity(1)))
      );
    (this.Ot && this.Zt.innerRect
      ? ((this.kt = !0),
        (this.Ut = this.pswp.container),
        (this.Vt = this.pswp.currSlide.holderElement),
        (t.container.style.overflow = "hidden"),
        (t.container.style.width = t.viewportSize.x + "px"))
      : (this.kt = !1),
      this.isOpening
        ? (this.Gt && ((t.bg.style.opacity = 0.003), (t.template.style.opacity = 1)),
          this.Rt && ((t.template.style.opacity = 0.003), t.applyBgOpacity(1)),
          this.Ot &&
            (this.qt(),
            this.Ft && ((this.Ft.willChange = "transform"), (this.Ft.style.opacity = 0.003))))
        : this.isClosing &&
  ...
  Pt() {
    this.isOpening && this.Bt && this.Ft && "IMG" === this.Ft.tagName
      ? new Promise((t) => {
          let i = !1,
            s = !0;
          var h;
  ...
  Ht() {
    (this.pswp.template.style.setProperty("--pswp-transition-duration", this.At + "ms"),
      this.pswp.dispatch("initialZoom" + (this.isOpening ? "In" : "Out")),
      this.pswp.template.classList[this.isOpening ? "add" : "remove"]("pswp--ui-visible"),
      this.isOpening
        ? (this.Ft && (this.Ft.style.opacity = 1), this.Kt())
  ...
  Kt() {
    ...
    (this.Ot &&
      (this.kt &&
        (this.Xt(this.Ut, "transform", "translate3d(0,0,0)"),
        this.Xt(this.Vt, "transform", "none")),
      t.currSlide.zoomAndPanToInitial(),
      this.Xt(t.currSlide.container, "transform", t.currSlide.getCurrentTransform())),
      this.Gt && this.Xt(t.bg, "opacity", t.options.bgOpacity),
      this.Rt && this.Xt(t.template, "opacity", 1));
  }
  jt() {
    const { pswp: t } = this;
    (this.Ot && this.qt(!0),
      this.Gt && t.bgOpacity > 0.01 && this.Xt(t.bg, "opacity", 0),
      this.Rt && this.Xt(t.template, "opacity", 0));
  }
  qt(t) {
    const { pswp: s } = this,
      { innerRect: h } = this.Zt,
    ...
    if (this.kt) {
      const i = -n.x + (this.Zt.x - h.x) + h.w,
        s = -n.y + (this.Zt.y - h.y) + h.h,
        e = n.x - h.w,
        a = n.y - h.h;
      t
        ? (this.Xt(this.Ut, "transform", o(i, s)), this.Xt(this.Vt, "transform", o(e, a)))
        : (r(this.Ut, i, s), r(this.Vt, e, a));
    }
    (i(e.pan, h || this.Zt),
      (e.currZoomLevel = this.Zt.w / e.width),
...
function J(t, i) {
  ...
  if (!i.dispatch("lazyLoadSlide", { index: t, itemData: s }).defaultPrevented)
    return (function (t, i, s) {
      const h = i.createContentFromData(t);
...
class Q {
  ...
  loadSlideByIndex(t) {
    ...
    const i = Y(this.pswp.getItemData(t), t);
    let s = this.getContentByKey(i);
    s || ((s = J(t, this.pswp)), (s.key = i), this.addToCache(s));
  }
  getContentBySlide(t) {
    let i = this.getContentByKey(this.getKeyBySlide(t));
    return (
      i ||
        ((i = this.pswp.createContentFromData(t.data)),
        (i.key = this.getKeyBySlide(t)),
        this.addToCache(i)),
      i.setSlide(t),
      i
    );
  ...
  addToCache(t) {
    if ((this.removeByKey(t.key), this.Yt.push(t), this.Yt.length > this.limit)) {
      const t = this.Yt.findIndex((t) => !t.isAttached);
      if (-1 !== t) {
  ...
  removeByKey(t) {
    const i = this.Yt.findIndex((i) => i.key === t);
    -1 !== i && this.Yt.splice(i, 1);
  }
  getContentByKey(t) {
    return this.Yt.find((i) => i.key === t);
  }
  getKeyBySlide(t) {
    return Y(t.data, t.index);
  }
  destroy() {
    (this.Yt.forEach((t) => t.destroy()), (this.Yt = null));
  }
}
const $ = {
  allowPanToNext: !0,
...
class tt extends class extends class {
  ...
  addFilter(t, i, s = 100) {
    (this.Qt[t] || (this.Qt[t] = []),
      this.Qt[t].push({ fn: i, priority: s }),
      this.Qt[t].sort((t, i) => t.priority - i.priority),
      this.pswp && this.pswp.addFilter(t, i, s));
  }
  removeFilter(t, i) {
    (this.Qt[t] && (this.Qt[t] = this.Qt[t].filter((t) => t.fn !== i)),
  ...
  off(t, i) {
    (this.Jt[t] && (this.Jt[t] = this.Jt[t].filter((t) => i !== t)),
  ...
  constructor() {
    (super(), (this.contentTypes = { image: W, html: j }));
  }
  getNumItems() {
    let t;
    ...
    i
      ? i.length
        ? (t = i.length)
        : i.gallery && (i.items || (i.items = this.$t(i.gallery)), i.items && (t = i.items.length))
      : (t = 0);
  ...
  getContentClass(t) {
    return t.type
      ? this.contentTypes[t.type]
      : t.src
        ? this.contentTypes.image
        : t.html
          ? this.contentTypes.html
          : void 0;
  }
  createContentFromData(t) {
    return new (this.getContentClass(t))(t, this);
  }
  getItemData(t) {
    const { dataSource: i } = this.options;
    let s;
    Array.isArray(i)
      ? (s = i[t])
      : i && i.gallery && (i.items || (i.items = this.$t(i.gallery)), (s = i.items[t]));
    let h = s;
  ...
  ti(t) {
    ...
    if (s) {
      ((i.src = s.dataset.pswpSrc || s.href),
        (i.srcset = s.dataset.pswpSrcset),
        (i.w = parseInt(s.dataset.pswpWidth, 10)),
        (i.h = parseInt(s.dataset.pswpHeight, 10)),
  ...
  init() {
    ...
    return (
      ...
      this.dispatch("gettingData", this.currIndex, this.ei, !0),
      (this.Lt = this.getThumbBounds()),
  ...
  setContent(t, i) {
    if ((t.slide && t.slide.destroy(), this.options.loop)) i = this.getLoopedIndex(i);
    else if (i < 0 || i >= this.getNumItems()) return void (t.el.innerHTML = "");
    const s = this.getItemData(i);
    ((t.slide = new x(s, i, this)),
  ...
  hi() {
    ((this.template = t("pswp")),
      this.template.setAttribute("tabindex", -1),
      this.template.setAttribute("role", "dialog"),
      (this.bg = t("pswp__bg", !1, this.template)),
      (this.scrollWrap = t("pswp__scroll-wrap", !1, this.template)),
    ...
    return (function (t, i, s) {
      ...
      if (e && !1 !== s.options.thumbSelector) {
        const t = s.options.thumbSelector || "img",
          h = e.matches(t) ? e : e.querySelector(t);
        h &&
          (n = i.thumbCropped
            ? (function (t, i, s) {
...
export { j as Content, W as ImageContent, tt as default };

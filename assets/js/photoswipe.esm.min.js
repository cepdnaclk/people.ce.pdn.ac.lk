...
class M {
  ...
  S(t) {
    ...
    if (s.options.allowPanToNext && "x" === h && "x" === t && !n) {
      ...
      ("y" === t && (r.isShifted() || l.min.y === l.max.y)) || this.v(t, u);
  }
  M(t) {
    return (
      ...
      s.animations.startSpring({
        ...
        onUpdate: (t) => {
          if (((t /= 1e3), d || a)) {
            if (
              (d &&
                ((h.pan.x = u.x + (p.x - u.x) * t),
                (h.pan.y = u.y + (p.y - u.y) * t)),
              a)
            ) {
              const i = o + (r - o) * t;
              h.setZoomLevel(i);
...
class T {
  ...
  Z(t, i, s) {
    ...
    if (
      !h.dispatch(t + "Action", { point: i, originalEvent: s }).defaultPrevented
    )
...
class E {
  ...
  easeFrame(t, i) {
    ...
    if (1 === this.bt)
      ...
      ((h = e * (t * n + s * o)),
        (this.velocity =
          h * -this.xt * this.bt + e * (-this.Mt * t * o + this.Mt * s * n)));
    }
    return h;
  }
}
...
class F {
  constructor(i, s) {
    ...
    ("bar" === r
      ? (i.topBar ||
          (i.topBar = t("pswp__top-bar pswp__hide-on-close", !1, i.scrollWrap)),
        (a = i.topBar))
      : (n.classList.add("pswp__hide-on-close"),
        (a = "wrapper" === r ? i.scrollWrap : i.template)),
      a.appendChild(n));
  }
}
function B(t, i, s) {
...
class H {
  ...
  Ct() {
    ...
    if ((this.pswp.opener.isOpen || (h = i.zoomLevels.initial), h === this.Dt))
      return;
    this.Dt = h;
...
class j {
  ...
  onLoaded() {
    ((this.state = p),
      this.slide && this.pswp.dispatch("loadComplete", { slide: this.slide }));
  }
  keepPlaceholder() {
    return this.state === u;
  }
...
class X {
  ...
  Et() {
    ...
    if (
      ...
      (this.Bt = this.At > 50),
      (this.Ot =
        Boolean(this.Zt) && (!this.isClosing || !t.mainScroll.isShifted())),
      this.Ot
      ...
      return (
        ...
        void (
          this.isOpening &&
          ((t.template.style.opacity = 0.003), t.applyBgOpacity(1))
        )
      );
    (this.Ot && this.Zt.innerRect
      ...
      this.isOpening
        ? (this.Gt &&
            ((t.bg.style.opacity = 0.003), (t.template.style.opacity = 1)),
          this.Rt && ((t.template.style.opacity = 0.003), t.applyBgOpacity(1)),
          this.Ot &&
            (this.qt(),
            this.Ft &&
              ((this.Ft.willChange = "transform"),
              (this.Ft.style.opacity = 0.003))))
        : this.isClosing &&
  ...
  qt(t) {
    ...
    if (this.kt) {
      const i = -n.x + (this.Zt.x - h.x) + h.w,
        ...
        a = n.y - h.h;
      t
        ? (this.Xt(this.Ut, "transform", o(i, s)),
          this.Xt(this.Vt, "transform", o(e, a)))
...
class Q {
  ...
  addToCache(t) {
    if (
      (this.removeByKey(t.key), this.Yt.push(t), this.Yt.length > this.limit)
    ) {
...
class tt extends class extends class {
  ...
  getNumItems() {
    ...
    i
      ? i.length
        ? (t = i.length)
        : i.gallery &&
          (i.items || (i.items = this.$t(i.gallery)),
  ...
  getItemData(t) {
    ...
    Array.isArray(i)
      ...
      : i &&
        i.gallery &&
        (i.items || (i.items = this.$t(i.gallery)), (s = i.items[t]));
    let h = s;
  ...
  init() {
    ...
    return (
      ...
      this.on("loadError", (t) => {
        t.slide.heavyAppended &&
          (t.slide.removePlaceholder(), t.slide.displayError());
      }),
        ...
        h &&
          (n = i.thumbCropped
            ? (function (t, i, s) {
                ...
                return (
                  (c.innerRect = { w: h.width, h: h.height, x: r, y: a }),
                  c
                );
              })(h, i.w, i.h)
            : (function (t) {
